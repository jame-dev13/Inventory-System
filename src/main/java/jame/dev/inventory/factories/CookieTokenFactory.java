...
public class CookieTokenFactory {
   ...
   private static final String COOKIE_ACCESS_NAME = CookieName.JWT_ACCESS.getName();
   private static final String COOKIE_REFRESH_NAME = CookieName.JWT_REFRESH.getName();
